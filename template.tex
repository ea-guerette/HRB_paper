...
\Author[3]{Lubov}{Volkova}
\Author[3]{Christopher J.}{Weston}
\Author[4]{Carl P.}{Meyer}
...
\begin{figure}
  \includegraphics[width=14 cm]{C:/Users/eag873/Documents/GitHub/HRB_paper/figures/maps.png}
...
\begin{table}
  ...
  \begin{tabular}{l l c c  l l }
    ...
    Acetaldehyde & CO & 0.010 (0.002) & 0.007 $\pm$ 0.001 &50& 0.75\\
    Acetone & CO & 0.004 (0.001) & 0.0034 $\pm$ 0.0005 &47& 0.74 \\
    Acetonitrile$^a$ & CO & 0.005 (0.001) & 0.0038 $\pm$ 0.0005 &42& 0.91\\
    ...
    Furan + isoprene & CO & 0.0020 (0.0003) & 0.0019 $\pm$ 0.0003 &37& 0.87 \\
    Hydrogen cyanide & CO & & 0.0063 $\pm$ 0.0007 &50& 0.46 \\
    sum of MACR, MVK  & CO & & 0.0035 $\pm$ 0.0009 &44& 0.73 \\
    and 2-butenal& & & & & \\
    Methanol & CO & 0.023 (0.005) & 0.022 $\pm$ 0.002 &54& 0.72\\
...
\begin{table} 
  \caption{Summary of open-path FTIR measurements at prescribed fires in temperate forest in Victoria and comparison with similar results obtained at prescribed fires in NSW}
 \begin{tabular}{l l l l l l l l l l  } 
   ...
   CH$_4$ & CO & 0.0571  & 0.97 & 3.3 $\pm$ 0.2 & 0.0633  & 0.99 & 3.1 $\pm$ 0.2 &  0.05  & 3.6 (1.1) \\
   & & $\pm$ 0.0006& & &$\pm$ 0.0005 &  &&(0.01)&\\
   Ammonia & CO & 0.0276 & 0.98 & 1.7 $\pm$ 0.2 & 0.0291 & 0.95 & 1.5 $\pm$ 0.2 & 0.021  & 1.6 (0.6)\\
    & & $\pm$ 0.0003& & &$\pm$ 0.0004 &  &&(0.008)&\\
   Ethene & CO$_2$ & 0.00118 & 0.97 & 1.2 $\pm$ 0.3 & 0.00105 & 0.91 & 1.1 $\pm$ 0.2 & 0
   .0012& 1.3 (0.3) \\
   & & $\pm$ 0.00001& & &$\pm$ 0.00002 &  &&(0.0003)&\\
   Formaldehyde & CO$_2$ & 0.00133 & 0.94 & 1.5 $\pm$ 0.3 & 0.00113 & 0.82 & 1.3 $\pm$ 0.2 & 0.0016 & \\
   & & $\pm$ 0.00002& & &$\pm$ 0.00003 &  &&(0.0004)&\\
   Methanol & CO & 0.0144 & 0.96 & 1.7 $\pm$0.3 & 0.0154 & 0.95 & 1.5 $\pm$0.4 & 0.017 & 2.4 (1.2) \\
   & & $\pm$ 0.0002& & &$\pm$ 0.0006 &  &&(0.006)&\\
   Formic acid & CO & 0.00321 & 0.94 & 0.5 $\pm$ 0.2 & 0.00414 & 0.93 & 0.6 $\pm$ 0.1 & 0.0021 & 0.4 (0.2)\\
    & & $\pm$ 0.00005& & &$\pm$ 0.00007 &  &&(0.0007)&\\
   Acetic acid & CO & 0.0303 & 0.98 & 6.5 $\pm$ 1.2 & 0.0331 & 0.95 & 6.0 $\pm$ 0.9 & 0.015 & 3.8 (1.3)\\
     & & $\pm$ 0.0003& & &$\pm$ 0.0005 &  &&(0.003)&\\
 \bottomhline
\end{tabular}
\label{table:OP}
...
\begin{table}
  ...
  sum of furan and isoprene & Grab samples & -7 $\pm$ 2 & 7 $\pm$ 2 & 0.95 & 0.004 \\ 
  sum of acetone and propanal & Grab samples & -5 $\pm$ 1& 5 $\pm$ 1& 0.94 & 0.004 \\ 
    \bottomhline
  \end{tabular}
  \label{table:MCE_dep}
...
For other species, the results are mixed, with \citet{Akagi2013} finding no relationship to MCE for acetic acid but \citet{Burling2011} finding a strong one (with a slope of -45 $\pm$ 3) in a similar conifer ecosystem. This is analogous to the results presented here, where a strong relationship to MCE is found for a subset of the data (NSW fires only, slope = -86 $\pm$ 5) but no relationship is found when all the fires are considered. 
For formic acid, both studies find a relationship for conifer forest fires (with slopes of -1.8 $\pm$ 0.6 and -3.1 $\pm$ 0.2), but \citet{Burling2011} found no relationship for chaparral fires. The slope for formic acid for NSW fires was -12 $\pm$ 6. There was no relationship when all fires were included. 

For formaldehyde and ethene, \citet{Akagi2013} reports a weak or insignificant relationship to MCE whereas \citet{Burling2011} reports strong relationships to MCE for both species for fires in a similar conifer ecosystem (with slopes of -21 $\pm$ 2 for formaldehyde and -11 $\pm$ 2 for ethene) and a weak or insignificant relationship to MCE for fires in chaparral. For fires in Australian temperate forests, we observed slopes of -21 $\pm$ 10 for formaldehyde and -13 $\pm$ 4 for ethene. 

\citet{Akagi2013} report a slope of -16 $\pm$ 4 for acetone, which is larger than the one observed for acetone + propanal in this study (-5 $\pm$ 1). \citet{Akagi2013} also report significant relationships to MCE for ethane, benzene, toluene, xylenes, acetonitrile and acetaldehyde whereas no relationship was observed for these species in our study.
...
\begin{table}
 ...
 \begin{tabular}{l l l l l l l l } 
   ...
   & & & & & & plume & \\
     \citet{Rea2016} & Greater Sydney  & 0.91 & 1640& 107& 7.8$^b$& Transported  & Wildfires \\
     & Area, NSW& & & & & plume& \\   
   \citet{Paton-Walsh2014} & Greater Sydney & 0.90 (0.2) & 1620 (160) & 118 (19) & 36 (1.1) & Ground-based  & Prescribed \\
      & Area, NSW& & & & & OP-FTIR& fires \\
   This study & Victoria & 0.92 (0.01) & 1660 (170) & 93 (15) & 3.2 (0.2) & Ground-based & Prescribed  \\
      & & & & & & OP-FTIR & fires\\
...
Although the present study consisted of ground-based measurements, MCE and emission factors for CO$_2$, CO and CH$_4$ for Australian temperate ecosystems have all been measured from a variety of platforms, including airborne measurements \citep{Hurst1996} and measurements of plumes transported short distances to fixed monitoring stations \citep{Lawson2015,Rea2016}. These measurements are summarised in Table \ref{table:MCE_comp}. The values listed in  \citet[Table S4, February 2015 update]{Akagi2011} for temperate forests are also included for comparison. 

As can be seen from Table \ref{table:MCE_comp}, there is a relatively small spread of MCE values measured for fires in Australian temperate ecosystems. Even airborne measurements over the very large Sydney wildfires of January 1994 have a relatively low average MCE of 0.91 \citep{Hurst1996}. Furthermore, there is no significant difference in the MCE observed for wild or prescribed fires, or between measurement platforms (Kruskal-Wallis rank sum test, p > 0.7). This is in contrast with measurements conducted at prescribed fires in the US, where higher average MCE values were observed for airborne measurements than for open-path measurements on the ground (0.93 vs. 0.91 on average for the same fires in \citet{Akagi2014}. MCE values greater than 0.93 for airborne measurements have also been reported by other US studies \citep{Burling2011, Akagi2013}. The top left panel of Fig.~\ref{fig:MCE_dep} shows the CH$_4$ emission factors reported by \citet{Hurst1996} plotted alongside the OP-FTIR measurements conducted as part of this study and as part of \citet{Paton-Walsh2014}. The agreement between the two platforms is excellent. 
...
\dataavailability{All the emission ratios and emission factors measured as part of this study are summarized in a .csv file provided as a supplement to the main text.} %% use this section when having only data sets available
