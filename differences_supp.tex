...
%DIF DEL C:\Users\eag873\Documents\GitHub\HRB_paper\supp\supplementary.tex      Thu Sep 21 13:59:24 2017
%DIF ADD C:\Users\eag873\Documents\GitHub\HRB_paper\supplementary_revised.tex   Fri Jan 19 11:57:07 2018
%% ---------------------------------
...
It should be noted that hydrogen cyanide was assigned the same calibration factor as formaldehyde\DIFdelbegin \DIFdel{and }\DIFdelend \DIFaddbegin \DIFadd{. Both species have a similar m/z (and are therefore likely to be transmitted in a similar way through the instrument), similar proton affinities, similar kinetics and little water dependence when measured by SIFT-MS \mbox{%DIFAUXCMD
\citep{Spanel1999,Spanel2004}}\hspace{0pt}%DIFAUXCMD
. Similarly, }\DIFaddend pyrrole was assigned the same calibration factor as isoprene. The instrument response to monoterpenes was determined using $\alpha$-pinene and eucalyptol (1,8-cineole). 
