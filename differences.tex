...
%DIF ADD C:\Users\eag873\Documents\GitHub\HRB_paper\revised_manuscript.tex      Mon Jan 22 22:24:46 2018
%% ---------------------------------
...
Biomass burning emits a wide range of trace species, including greenhouse gases, particulate matter and volatile organic compounds (VOCs). Globally, fires are the second largest source of VOCs, with emissions estimated at 400 Tg yr$^{-1}$ on average \citep{Yokelson2008,Akagi2011}. Fires are also the main driver of inter-annual variability for species such as carbon monoxide and \DIFdelbegin \DIFdel{aerosol }\DIFdelend \DIFaddbegin \DIFadd{particulate matter }\DIFaddend \citep{Edwards2004,Edwards2006,Voulgarakis2015}.  

Australia emits 7-8 $\%$ of global annual biomass burning carbon emissions \citep{Ito2004,VanderWerf2010}. At a national level, average gross annual emissions of total carbon from fires (127 Tg C yr$^{-1}$) actually exceed those from burning fossil fuels (95 Tg C yr$^{-1}$) \citep{Haverd2013}. While net emissions of carbon from fires are lower due to \DIFdelbegin \DIFdel{rapid regrowth }\DIFdelend \DIFaddbegin \DIFadd{regrowth \mbox{%DIFAUXCMD
\citep{Haverd2013, Landry2016}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend , volatile organic species emitted by those fires are not subject to uptake by the regenerating vegetation and can therefore be considered net emissions. 

The mix of VOCs emitted during biomass burning may be ecosystem-specific, \DIFdelbegin \DIFdel{especially for VOCs that are associated with biogenic processes (as opposed to combustion processes) and that are }\DIFdelend \DIFaddbegin \DIFadd{with species such as monoterpenes being }\DIFaddend distilled from the vegetation \DIFdelbegin \DIFdel{in the early stages of the }\DIFdelend \DIFaddbegin \DIFadd{as it is heated by the approaching }\DIFaddend fire \citep{Ciccioli2014}. \DIFdelbegin \DIFdel{Species such as methanol}\DIFdelend \DIFaddbegin \DIFadd{Methanol}\DIFaddend , acetic acid, acetaldehyde, acetone and monoterpenes have \DIFaddbegin \DIFadd{all }\DIFaddend been detected from heated \textit{Eucalyptus} leaves in laboratory experiments, with differences observed between fresh leaves and senescent leaves \citep{Greenberg2006,Maleknia2007,Maleknia2009,Possell2013}. Other factors that impact smoke composition include fuel composition \citep[e.g. nitrogen content,][]{Coggon2016} and fire behaviour \citep[e.g.][]{Wooster2011}. %and fuel moisture \citep[e.g.][]{Hoffa1999}. 
...
This paper presents results from a dedicated ground measurement program that sampled smoke at several prescribed fires organised by the New South Wales \DIFaddbegin \DIFadd{(NSW) }\DIFaddend National Parks and Wildlife Service in the greater Sydney area and by the Department of Environment, Land, Water and Planning %(DELWP)
...
An open-path FTIR system was deployed at five prescribed fires in NSW and at the two prescribed fires in Victoria, as indicated in the last column of Table S1. The system used in this project is described in detail in \citet{Paton-Walsh2014}. Briefly, the spectrometer (Bomem MB-100 Series, 1 cm$^{-1}$ resolution) has a built-in infrared source and is placed 20-50 meters away from a set of retro-reflectors positioned so that smoke from the fire crosses the path in between. The system can run autonomously and records a spectrum consisting of three scans, approximately every twenty seconds. \DIFaddbegin \DIFadd{Ambient pressure and temperature are monitored at one end of the path, through a barometer (Vaisala PTB110) and a resistance temperature detector (RTD PT100) connected to the computer controlling the spectrometer via an I/O box. The output is logged at the same time resolution as the spectral measurements. 
%DIF > Ambient pressure is not expected to vary much along the measurement path, however temperature may be significantly affected by flames crossing the path. This is considered in the uncertainty budget developed by \citet{Paton-Walsh2014} for the OP-FTIR measurements of emission factors.  
}

\DIFaddend Typically, the system is set up and starts recording before the fire is ignited, and is left to run until mole fractions return to ambient values. As the measurement is integrated over a path of several meters and is continuous over the duration of the fire, the emissions measured using this technique are likely to capture smoke from all stages of the fire, and therefore to be representative of the whole fire. One of the great advantages of OP-FTIR is that there is no sample capture, avoiding losses due to walls or sample lines. 

In April 2015, the OP-FTIR was deployed at two prescribed burns in temperate forests in Victoria, several hundred kilometres away from the fires sampled in 2010-2013. The first fire, on April 13$^{th}$, was near Greendale, Victoria, and the second, on April 23$^{rd}$, was in Kalimna Park, Castlemaine, Victoria (see Fig.~\ref{fig:map} for a map of the locations). At the Greendale fire, the spectrometer was positioned along a \DIFdelbegin \DIFdel{forest road }\DIFdelend \DIFaddbegin \DIFadd{fire trail }\DIFaddend and the retro-reflectors were installed 45 m away within the woodland area to be burned, so that both smoke and flames passed through the line of sight of the instrument. At the Castlemaine fire, both the spectrometer and the retro-reflectors were positioned along a \DIFdelbegin \DIFdel{forest track }\DIFdelend \DIFaddbegin \DIFadd{fire trail }\DIFaddend downwind of the fire, so that smoke would blow through the 50 m measurement path. The instrument set-up at both fires is shown in Fig.~\ref{fig:OP}. The details of the NSW deployments are in \citet{Paton-Walsh2014}. 

The OP-FTIR spectra collected during the fires were subsequently analysed to derive mole fractions of \DIFaddbegin \DIFadd{carbon dioxide (}\DIFaddend CO$_2$\DIFdelbegin \DIFdel{, CO, }\DIFdelend \DIFaddbegin \DIFadd{), carbon monoxide (CO), methane (}\DIFaddend CH$_4$\DIFaddbegin \DIFadd{)}\DIFaddend , acetic acid \DIFaddbegin \DIFadd{(CH$_3$COOH), ammonia (NH$_3$), ethene (C$_2$H$_4$), formaldehyde (H$_2$CO)}\DIFaddend , \DIFdelbegin \DIFdel{ammonia, ethene, formaldehyde, }\DIFdelend formic acid \DIFdelbegin \DIFdel{and methanol }\DIFdelend \DIFaddbegin \DIFadd{(HCOOH) and methanol (CH$_3$OH) }\DIFaddend using the Multiple Atmospheric Layer Transmission (MALT) model \citep{Griffith1996,Griffith2012} and the spectral windows described in \citet{Paton-Walsh2014}. \DIFaddbegin \DIFadd{The uncertainty on individual measurements is the error on the retrieval reported by MALT. For a complete uncertainty budget for the OP-FTIR measurements in smoke, see Appendix B of \mbox{%DIFAUXCMD
\citet{Paton-Walsh2014}}\hspace{0pt}%DIFAUXCMD
.
}\DIFaddend 
...
Samples were collected in 600 ml glass flasks, except at the Gulguer Plateau fire, where samples were collected into 1 L Tedlar bags. The glass flasks were pre-evacuated using a turbo-molecular pump (Pfeiffer TCS 010) prior to deployment to the fires, and filled with smoke on site by opening them for a few seconds. \DIFaddbegin \DIFadd{No sample line was affixed to the flasks for sampling; flasks were positioned in the smoke prior to opening them. }\DIFaddend The bags were flushed with high purity nitrogen and brought to the Gulguer Plateau fire where they were filled with smoke using a differential pressure system or 'vacuum box' powered by a generator. \DIFaddbegin \DIFadd{As the generator had to be placed away from the fire, a sample line ($\sim$5 meters) was attached to the vacuum box. }\DIFaddend Filling the bags took a few minutes, and consequently, most samples were collected from large smouldering targets after the fire front had moved through the sampling area. 

All grab samples were brought back to the lab and analysed within 24 hours of collection. A Fourier Transform Infrared (FTIR) spectrometer coupled to a White cell was used to measure \DIFaddbegin \DIFadd{carbon dioxide (}\DIFaddend CO$_2$\DIFdelbegin \DIFdel{, CO, }\DIFdelend \DIFaddbegin \DIFadd{), carbon monoxide (CO), methane (}\DIFaddend CH$_4$\DIFdelbegin \DIFdel{, ethane and ethene}\DIFdelend \DIFaddbegin \DIFadd{), ethane (C$_2$H$_6$) and ethene (C$_2$H$_4$)}\DIFaddend . VOC mole fractions were measured using selective ion flow tube mass spectrometry (SIFT-MS).


\subsubsection{Fourier Transform Infrared (FTIR) spectrometer coupled to a White cell (White cell FTIR)}
Mole fractions of CO$_2$, CO, CH$_4$, \DIFdelbegin \DIFdel{ethane and ethene }\DIFdelend \DIFaddbegin \DIFadd{C$_2$H$_6$ and C$_2$H$_4$ }\DIFaddend in the grab samples of smoke collected at the fires were measured using a Bomem MB-100 Series FTIR spectrometer (1 cm$^{-1}$ resolution). This spectrometer is coupled to a multi-pass optical (White) cell with a path of 22.2 m and is fitted with \DIFdelbegin \DIFdel{a InSb}\DIFdelend \DIFaddbegin \DIFadd{an indium antimony (InSb) }\DIFaddend detector cooled with liquid nitrogen. 

Part of the sample was transferred to the evacuated White cell and the temperature and pressure inside the cell were logged. Typical temperatures and pressures inside the White cell were 22$^\circ$C and 220 hPa, respectively. A spectrum \DIFaddbegin \DIFadd{consisting of 78 scans }\DIFaddend was acquired for each grab sample\DIFdelbegin \DIFdel{by co-adding 78 scans. As for the OP-FTIR spectra, mole }\DIFdelend \DIFaddbegin \DIFadd{. Mole }\DIFaddend fractions were retrieved using the Multiple Atmospheric Layer Transmission (MALT) model \citep{Griffith1996,Griffith2012}. \DIFaddbegin \DIFadd{The uncertainty on individual grab sample measurements is taken as the error reported by MALT for the retrieval. 
 }\DIFaddend 
...
This means that the instrument dilutes the sample by a factor that is a function of the pressure and temperature inside the flow tube, and of the flows of sample and carrier gases. This makes the instrument less sensitive than PTR-MS \citep{Blake2009} but ideally suited for the analysis of highly polluted air, such as smoke samples. The flow tube dilution ratio \DIFdelbegin \DIFdel{in this study was }\DIFdelend \DIFaddbegin \DIFadd{under standard operating conditions is }\DIFaddend about 1:15.  

The SIFT-MS was operated in multiple ion mode, targeting eighteen VOC species. Table S2 lists the species targeted, the reagent ion used, the mass-to-charge ratios measured and the calibration factors used to quantify them. The list includes aromatic species, nitrogen-containing species, some oxygenated species, some small hydrocarbons and some biogenic species, targeting a breadth of chemical classes. The species targeted were for the most part the most abundant reported at their nominal molecular mass by \citet{Yokelson2013}, who deployed extensive instrumentation in a laboratory setting and calculated emission factors for 357 species. A notable exception is the signal at NO$^+$ 68, which is calibrated using isoprene, but is expected to be dominated by furan in smoke samples. Also, the signal at H$_3$O$^+$ 71 is expected to include 2-butenal as well as methacrolein \DIFaddbegin \DIFadd{(MACR) }\DIFaddend and methyl vinyl ketone \DIFaddbegin \DIFadd{(MVK)}\DIFaddend . 
The measurement cycle took approximately 7 seconds to complete and was repeated 8 times on each smoke sample. Mole fractions of VOCs were computed from raw SIFT-MS spectra using the calibration factors listed in Table S2. For each sample, an average mole fraction was calculated for each species by taking the mean over all repeats. \DIFaddbegin \DIFadd{The standard deviation of the mean was taken as the uncertainty on the average mole fraction. }\DIFaddend An average mole fraction was reported for a given species only if its signal-to-noise ratio was greater than three, i.e. if the average signal was at least three times greater than the standard deviation of its mean. 

\begin{figure}[t]
  \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=8.3 cm]{C:/Users/eag873/Documents/GitHub/HRB_paper/figures/Ethene_w_error_bars.png}
%DIFDELCMD <   %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=8.3 cm]{C:/Users/eag873/Documents/GitHub/HRB_paper/figures/Ethene_w_error_bars_bigger_no_pts.png}
  \DIFaddendFL \caption{Comparison of ethene mole fractions measured by SIFT-MS with those measured by White cell FTIR in grab samples of smoke collected at Australian temperate forest fires. \DIFaddbeginFL \DIFaddFL{Error bars for the SIFT-MS are the standard deviation of the measurement, for the White cell FTIR they are the error on the retrieval. The line of best fit was determined using orthogonal regression.
  }\DIFaddendFL }
  \label{fig:ethene}
\end{figure}
...
Emission ratios (ER) were derived by plotting VOC mole fractions against those of CO or CO$_2$ (or another reference VOC species in some cases, see below) and applying an orthogonal regression. Orthogonal regression finds the best line of fit by minimising squared distances between (x, y) points and their projection on the line of best fit. The regression is also weighted by the uncertainties in both x and y, which, in this case, are the measurement uncertainties \DIFdelbegin \DIFdel{.
}\DIFdelend \DIFaddbegin \DIFadd{described above, so that the line of best fit has greater dependence on the more precise data points. The slope of the line of best fit is the emission ratio. As noted in a recent evaluation of linear regression techniques \mbox{%DIFAUXCMD
\citep{Wu2017}}\hspace{0pt}%DIFAUXCMD
, the type of linear regression applied has little impact on the resulting slope as long as the correlation coefficient is high. For this reason, we chose pairs of species that were well correlated to derive emission ratios and do not report results when R$^2$ < 0.5, as this should yield the most robust results. More generally, we chose to use linear regression to derive ER instead of calculating a value from each measurement \mbox{%DIFAUXCMD
\citep[e.g.][]{Burling2011} }\hspace{0pt}%DIFAUXCMD
because the background mole fractions of many measured species were poorly defined, often being below the detection limit of the SIFT-MS. Deriving emission ratio through regression without first subtracting background values introduces very little error \mbox{%DIFAUXCMD
\citep[< $0.1 \%$,][]{Wooster2011}}\hspace{0pt}%DIFAUXCMD
.
}\DIFaddend 

\DIFaddbegin \DIFadd{Emission ratios were derived from the open-path measurements for each fire separately. The mean ER from all the fires sampled is then our best estimate for the ecosystem. }\DIFaddend For the grab samples, emission ratios were derived for individual fires when possible; however, the VOC results from the targeted grab sampling were more highly variable than the open-path measurements in the well-mixed smoke, as is common for this type of sampling \citep{Yokelson2008,Yokelson2013,Burling2011,Akagi2013}. This resulted in poor correlations (R$^2$ < 0.5) for some species for certain fires. Also, not every trace gas species was present at a detectable level in every sample. For some fires, this resulted in too few samples to allow an emission ratio to be meaningfully derived by regression for that species. \DIFdelbegin \DIFdel{For this reason, emission ratios for each species were also derived through combining samples from all fires}\DIFdelend \DIFaddbegin \DIFadd{As ER were not successfully derived for each fire for some species, a mean ER was not necessarily the best estimate for the ecosystem. To derive a best estimate for the ecosystem, all valid samples were combined irrespective of which fire they were collected at and a single ER derived through orthogonal regression}\DIFaddend . 
Certain VOC species \DIFaddbegin \DIFadd{measured in the grab samples }\DIFaddend did not correlate strongly with either CO or CO$_2$. In those cases, emission ratios were derived using another reference species, e.g. an emission ratio to acetonitrile was derived for pyrrole, and ethene was used as a reference species to derive an emission ratio for benzene, 1,3-butadiene and acetylene. \DIFaddbegin \DIFadd{Good correlation between VOC species may indicate co-emission. 
}\DIFaddend 

\subsection{Determination of emission factors (EF) \DIFaddbegin \DIFadd{and modified combustion efficiency (MCE)}\DIFaddend }
...
\DIFaddbegin \DIFadd{MCE is a proxy for combustion efficiency, which is defined as the proportion of total carbon emitted by a fire released as CO$_2$. MCE is defined as the excess mole fraction of CO$_2$ divided by the sum of the excess mole fractions of CO$_2$ and CO \mbox{%DIFAUXCMD
\citep{Hao1993,Yokelson1996}}\hspace{0pt}%DIFAUXCMD
:
}\begin{equation} \DIFadd{\label{eq:MCE}
MCE = \frac{\Delta CO_2}{\Delta CO_2 + \Delta CO}
}\end{equation}

\DIFadd{When the fire is dominated by flaming combustion, the modified combustion efficiency is high, meaning that the emissions are dominated by CO$_2$. The combustion efficiency decreases as smouldering combustion and emissions of CO become more dominant. Flaming combustion is generally associated with MCE values greater than 0.9 and smouldering combustion with values below 0.9 \mbox{%DIFAUXCMD
\citep{Yokelson1996, Bertschi2003}}\hspace{0pt}%DIFAUXCMD
.
}

\DIFaddend There are variants on how to apply the equations above, see \citet{Paton-Walsh2014} for a discussion. In this project, we chose the same approach as in \citet{Paton-Walsh2014} to process the open-path FTIR data and calculated emission factors for CO and CO$_2$ using Eq. \ref{eq:EF:delta_ratio} with $ \frac{C_X}{C_T} $ calculated using the total excess amounts of each gas detected by summing over the excess amounts from each measurement. The emission factors of other species were calculated using Eq.~\ref{eq:EF:from_ER}.
\DIFdelbegin %DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{Emission factors for CO, CO}\DIFdelend \DIFaddbegin \DIFadd{Similarly, the MCE of a fire sampled by OP-FTIR was determined from the total excess amounts of CO}\DIFaddend $_2$ \DIFaddbegin \DIFadd{and CO detected by the open-path system (i.e. by summing the excess amounts from each measurement recorded). These MCE values are used to determine whether the emission factors of the species measured by OP-FTIR have a dependence on MCE. 
}

\DIFadd{For grab samples, two variants of the analysis were completed. The first one was used to derive emission factors and MCE values to evaluate whether the emission factors of the species measured only in the grab samples have a dependence on MCE. For this analysis, emission factors for CO$_2$, CO }\DIFaddend and CH$_4$ were calculated for each individual grab sample using Eq.~\ref{eq:EF:delta_ratio}, with C$_T$ calculated as the sum of CO$_2$, CO and CH$_4$ only. \DIFdelbegin \DIFdel{These were }\DIFdelend \DIFaddbegin \DIFadd{Although many more carbon-containing species were measured in the grab samples, only CO$_2$, CO and CH$_4$ were successfully quantified in every single grab sample. For consistency, they were therefore the only species included in the calculation. Doing so inflates the emission factors by up to a few percent (< $5 \%$) \mbox{%DIFAUXCMD
\citep{Gilman2015,Yokelson2013}}\hspace{0pt}%DIFAUXCMD
. The emission factors for CO and CO$_2$ were }\DIFaddend then used with Eq.~\ref{eq:EF:from_ER} \DIFaddbegin \DIFadd{and the emission ratios determined for individual fires, }\DIFaddend to derive emission factors for \DIFdelbegin \DIFdel{individual fires. To determine study-average emission factors from the grab sample data}\DIFdelend \DIFaddbegin \DIFadd{each fire. MCE was calculated for each sample using Eq.~\ref{eq:MCE} and an average value determined for each fire. These MCE values are indicative of the type of combustion (e.g. flaming vs. smouldering) captured by the grab sampling, and are not necessarily representative of the whole fire. As an example, the average MCE of the grab samples collected at the Gulguer Plateau fire - where grab samples were mostly collected from smouldering logs - was 0.78 $\pm$ 0.09, whereas a fire-integrated value of 0.90 was measured by OP-FTIR \mbox{%DIFAUXCMD
\citep{Paton-Walsh2014}}\hspace{0pt}%DIFAUXCMD
.
}

\DIFadd{The second variant was used to determine ecosystem-average emission factors for the species measured only in the grab samples. In this case}\DIFaddend , we used Eq.~\ref{eq:EF:from_ER} \DIFaddbegin \DIFadd{with the emission ratios derived from combining all data together, }\DIFaddend and the emission factors for CO and CO$_2$ derived from the in situ OP-FTIR measurements at the NSW fires. If the emission ratio for a given VOC was derived using another VOC (instead of CO or CO$_2$), their emission ratio was first converted to an emission ratio to CO or CO$_2$ using the emission ratio of their reference VOC to CO or CO$_2$. The uncertainty on the resulting emission ratio to CO (or CO$_2$) was calculated by adding the uncertainties in quadrature. 

 
\DIFdelbegin \subsection{\DIFdel{Calculation of modified combustion efficiency (MCE) }}
%DIFAUXCMD
\addtocounter{subsection}{-1}%DIFAUXCMD
\DIFdel{MCE is a proxy for combustion efficiency, which is defined as the proportion of total carbon emitted by a fire released as CO$_2$. MCE is defined as the excess mole fraction of CO$_2$ divided by the sum of the excess mole fractions of CO$_2$ and CO \mbox{%DIFAUXCMD
\citep{Hao1993,Yokelson1996}}\hspace{0pt}%DIFAUXCMD
:
}%DIFDELCMD < 

%DIFDELCMD < %%%
\begin{displaymath} \DIFdel{%DIFDELCMD < \label{eq:MCE}%%%
MCE = \frac{\Delta CO_2}{\Delta CO_2 + \Delta CO}
}\end{displaymath}
 %DIFAUXCMD
%DIFDELCMD < 
...
\begin{table}
  \caption{Summary of emission ratios (ER) determined for species measured by SIFT-MS and White cell FTIR in grab samples collected at the NSW fires. Mean ER is the average ER measured at individual fires. The "all data combined" ER was derived \DIFdelbeginFL \DIFdelFL{using a linear }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{through orthogonal }\DIFaddendFL regression \DIFaddbeginFL \DIFaddFL{on all available samples irrespective of which fire they were collected at}\DIFaddendFL .
  }
  \begin{tabular}{l l c c  l l }
    ...
    Acetonitrile \DIFdelbeginFL \DIFdelFL{$^a$ }\DIFdelendFL & CO & \DIFdelbeginFL \DIFdelFL{0.0039 (0.0008}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.004 (0.001}\DIFaddendFL ) & 0.0038 $\pm$ 0.0005\DIFaddbeginFL \DIFaddFL{$^a$ }\DIFaddendFL &42& 0.91\\
    ...
    \bottomhline
  \end{tabular}
  \DIFdelbeginFL %DIFDELCMD < \belowtable{
%DIFDELCMD <     $^a$ values reported exclude the Gulguer Plateau fire - see text for detail 
%DIFDELCMD <     

%DIFDELCMD <     $^b$ value reported is for the Alfords Point fire} %%%
\DIFdelendFL \DIFaddbeginFL \belowtable{
...
Similarly, the emission ratio of acetonitrile to CO is markedly lower at Gulguer Plateau than at the other fires. This could be due to the lower nitrogen content of logs compared to foliage and twigs \citep{Susott1996,Snowdon2005}, resulting in lower emissions of nitrogen-containing species \citep{Coggon2016}. \DIFdelbegin \DIFdel{The emission ratio measured for acetonitrile at Gulguer Plateau is excluded from the mean emission ratio listed in Table \ref{table:grab}. Including this emission ratio reduces the mean ER from 0.05 $\pm$ 0.01 to 0.04 $\pm$ 0.02. The Gulguer fire is also }\DIFdelend %DIF > The emission ratio measured for acetonitrile at Gulguer Plateau is excluded from the mean emission ratio listed in Table \ref{table:grab}. Including this emission ratio reduces the mean ER from 0.05 $\pm$ 0.01 to 0.04 $\pm$ 0.02. 
\DIFaddbegin \DIFadd{The Gulguer Plateau fire samples are }\DIFaddend excluded from the emission ratio for acetonitrile derived from combining data from all fires, since including \DIFdelbegin \DIFdel{it }\DIFdelend \DIFaddbegin \DIFadd{them }\DIFaddend results in R$^2$ < 0.5. Figure \ref{fig:Acetonitrile} shows the correlations of acetonitrile with CO; the Gulguer Plateau fire is shown in red, the other four fires are shown in black. \DIFaddbegin \DIFadd{The emission ratio derived from the black line is not significantly different from the mean ER that includes the Gulguer Plateau data (see Table~\ref{table:grab}). 
}\DIFaddend Pyrrole showed the same behaviour against CO as acetonitrile. Its emission ratio was therefore derived to acetonitrile instead of CO.  
...
This indicates that the 'all data combined' emission ratios listed in Table\DIFdelbegin \DIFdel{\ref{table:grab} should be similarly }\DIFdelend \DIFaddbegin \DIFadd{~\ref{table:grab} are }\DIFaddend representative of the ecosystem sampled - a useful result since this is the only ER available for some species. 
Whole-fire emission factors were then calculated using the 'all data combined' emission ratios listed in Table\DIFaddbegin \DIFadd{~}\DIFaddend \ref{table:grab} and the average fire-integrated emission factors for CO and CO$_2$ measured by OP-FTIR at the NSW fires by \citet{Paton-Walsh2014} and reproduced in the last column of Table~\ref{table:OP}. The resulting \DIFdelbegin \DIFdel{whole-fire }\DIFdelend \DIFaddbegin \DIFadd{ecosystem-average }\DIFaddend emission factors for all VOC species are listed in Table \ref{table:comp}.  
...
The magnitude of the slope and the intercept listed in Table~\ref{table:MCE_dep} reflects the magnitude of the emission factor for that species. The strength of the relationship is judged from the coefficient of determination (R$^2$) and the p-value \DIFdelbegin \DIFdel{. 
}\DIFdelend \DIFaddbegin \DIFadd{(the probability that there is no correlation between x and y). A poor R$^2$ indicates that MCE alone cannot explain the variability in EF. 
}\DIFaddend 

\begin{figure}
  \includegraphics[width=12 cm]{C:/Users/eag873/Documents/GitHub/HRB_paper/figures/MCE_v3.png}
  \caption{Dependence of emission factors on MCE. Open circles represent the seven fires sampled using OP-FTIR with the line of best fit shown in red. For formic acid and acetic acid, this regression line was derived using the measurements from the NSW fires only. The black circles represent average results from grab samples at four fires (\DIFaddbeginFL \DIFaddFL{The grab sampling results from }\DIFaddendFL the Gulguer Plateau fire \DIFdelbeginFL \DIFdelFL{falls }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{are either not available (methanol) or fall }\DIFaddendFL outside the range \DIFdelbeginFL \DIFdelFL{of MCE values }\DIFdelendFL measured by OP-FTIR \DIFaddbeginFL \DIFaddFL{(methane) }\DIFaddendFL and \DIFdelbeginFL \DIFdelFL{is }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{therefore do }\DIFaddendFL not \DIFdelbeginFL \DIFdelFL{shown}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{appear}\DIFaddendFL ). \DIFdelbeginFL \DIFdelFL{Purple }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{The purple }\DIFaddendFL triangles represent the methane results from the airborne measurements of Hurst et al. (1996) and the blue squares represent the emission factors measured for methane, methanol, and formaldehyde by Lawson et al. (2015) in a transported plume impacting the Cape Grim Baseline Air Pollution Station in Tasmania.
  }
  \label{fig:MCE_dep}
\end{figure}

\begin{table}
    \caption{Summary of \DIFaddbeginFL \DIFaddFL{regression statistics for the }\DIFaddendFL emission factor dependence on modified combustion efficiency (MCE) \DIFaddbeginFL \DIFaddFL{of carbon-containing species measured by open-path FTIR in temperate forest fires in Australia}\DIFaddendFL }
...
\DIFdelbegin \DIFdel{The }\DIFdelend \DIFaddbegin \DIFadd{For comparison purposes, the }\DIFaddend emission factors measured by \citet{Hurst1996} for CH$_4$ and \citet{Lawson2015} for CH$_4$, methanol and formaldehyde are also \DIFdelbegin \DIFdel{included }\DIFdelend \DIFaddbegin \DIFadd{plotted }\DIFaddend in Fig.~\ref{fig:MCE_dep}\DIFdelbegin \DIFdel{for comparison}\DIFdelend . Figure~\ref{fig:MCE_dep} also \DIFdelbegin \DIFdel{includes }\DIFdelend \DIFaddbegin \DIFadd{shows }\DIFaddend the average results derived \DIFdelbegin \DIFdel{from the grab samples for both }\DIFdelend \DIFaddbegin \DIFadd{for }\DIFaddend CH$_4$ and methanol \DIFdelbegin \DIFdel{for each fire except the }\DIFdelend \DIFaddbegin \DIFadd{from the grab samples. The grab sampling results from the }\DIFaddend Gulguer Plateau fire \DIFdelbegin \DIFdel{. The reasonable agreement with the }\DIFdelend \DIFaddbegin \DIFadd{are either not available (methanol) or fall outside the range measured by }\DIFaddend OP-FTIR \DIFdelbegin \DIFdel{measurements seen }\DIFdelend \DIFaddbegin \DIFadd{(methane) and therefore do not appear }\DIFaddend in Fig.~\ref{fig:MCE_dep}\DIFdelbegin \DIFdel{means that it may be possible to estimate the }\DIFdelend \DIFaddbegin \DIFadd{. 
%DIF > The reasonable agreement between the grab sampling results and the OP-FTIR measurements seen in Fig.~\ref{fig:MCE_dep} means that it may be possible to estimate the
The }\DIFaddend MCE-dependence of the species that were only measured in \DIFaddbegin \DIFadd{the }\DIFaddend grab samples (by SIFT-MS or White-cell FTIR) \DIFaddbegin \DIFadd{was also tested}\DIFaddend . For this analysis, average values from the five fires were used, spanning a range of average MCE of 0.78 to 0.93. No statistically significant trend was found for acetaldehyde, acetonitrile, benzene, butadiene, ethane and toluene, but there were significant trends for the sum of furan and isoprene and for the sum of acetone and propanal. The statistics for these trends are listed in Table~\ref{table:MCE_dep}. The MCE dependence of the other measured species could not be determined because fire-specific emission ratios were not available. 
...
%DIF < The slope for formic acid for NSW fires was -12 $\pm$ 6. There was no relationship when all fires were included. 
...
Considering the variability of relationships to MCE observed even for similar ecosystems, it seems likely that other factors are influencing emissions\DIFdelbegin \DIFdel{, especially of those species that are biogenically produced by vegetation and are not only a product of combustion.   
This }\DIFdelend \DIFaddbegin \DIFadd{. %DIF > , especially of those species that are biogenically produced by vegetation and are not only a product of combustion.
\mbox{%DIFAUXCMD
\citet{Burling2011} }\hspace{0pt}%DIFAUXCMD
sampled spring fires whereas \mbox{%DIFAUXCMD
\citet{Akagi2013} }\hspace{0pt}%DIFAUXCMD
sampled autumn fires so it is possible that some of the variability is due to seasonal differences. In this study, fires were sampled over several years, both in spring (August-September) and in autumn (April-May). There is no obvious seasonal effect in the data, however there seems to be regional effects, especially for formic acid and acetic acid, and these may be due to differences in vegetation.   
This variability }\DIFaddend limits the usefulness of MCE as a means of extrapolating emission factors for these species. Nevertheless, the MCE measured at a fire can be a good indication of whether a representative sample has been captured. This is explored in the next section by comparing MCE values observed from different measurement platforms for Australian temperate forest fires. 
...
\begin{table}
 ...
 \begin{tabular}{l l l l l l l l } 
   ...
   & Australia &&&&&& \DIFdelbeginFL %DIFDELCMD < \\ 
%DIFDELCMD <    & & & & & &  & %%%
\DIFdelendFL fire\\ 
  %DIF >  & & & & & &  &  \\
 ...
 \end{tabular}
\DIFdelbeginFL %DIFDELCMD < \belowtable{
%DIFDELCMD < $^a$ \citet{Hurst1996} assume 6 $\%$ of carbon is emitted as ash, which explains the lower emission factors reported for CO$_2$
%DIFDELCMD < 

%DIFDELCMD < $^b$ this value may be influenced by other sources - see \citet{Rea2016}
%DIFDELCMD < 

%DIFDELCMD < $^c$ Table S4, February 2015 update
%DIFDELCMD < } %%%
\DIFdelendFL \DIFaddbeginFL \belowtable{
...
\DIFdelbegin \DIFdel{Lower emissions of compounds such as monoterpenes would impact downwind plume chemistry as the smoke is photochemically processed (Akagi et al. 2013) }\DIFdelend \DIFaddbegin 

\DIFadd{Nitrogen-containing VOCs make little contribution to the overall reactivity of a smoke plume \mbox{%DIFAUXCMD
\citep{Gilman2015}}\hspace{0pt}%DIFAUXCMD
. Acetonitrile has an atmospheric lifetime on the order of months and is a tracer for long-range transport of biomass plumes \mbox{%DIFAUXCMD
\citep{Bange2000}}\hspace{0pt}%DIFAUXCMD
, whereas more reactive nitrogen-containing species may be tracers for fresh plumes \mbox{%DIFAUXCMD
\citep{Gilman2015,Coggon2016}}\hspace{0pt}%DIFAUXCMD
. Higher emissions may affect estimates of plume age based on these species. 
The difference with the North American fires may be due to higher fuel nitrogen content. Acacia are nitrogen-fixing species that have high leaf N content (1.50-3.55$\%$) which is partly conserved through leaf fall, leading to higher nitrogen in the leaf litter \mbox{%DIFAUXCMD
\citep{Snowdon2005}}\hspace{0pt}%DIFAUXCMD
. Acacia are some of the dominant understorey species in the forests investigated in this study, and their presence may have contributed to the high emissions of nitrogen-containing species; however, without fuel composition measurements, it is impossible to draw definitive conclusions. 
}

%DIF > Lower emissions of compounds such as monoterpenes would impact downwind plume chemistry as the smoke is photochemically processed (Akagi et al. 2013).
\DIFadd{The initial mixture of trace gases emitted by a fire is one of the factors (along with meteorology and the presence of other sources) that influences plume aging \mbox{%DIFAUXCMD
\citep{Akagi2012,Jaffe2012} }\hspace{0pt}%DIFAUXCMD
and air quality outcomes downwind of the fires}\DIFaddend .  
The use of Australian-specific emission factors is therefore recommended in studies looking at the regional impact of fires in Australian temperate forests. 
 ...
 %DIF < Such differences as observed here are likely to occur for other temperate regions of the globe as well, highlighting the need for either a more comprehensive compilation of emission factors to capture the likely variability in a global average, or more detailed inventories, including ecosystem-specific emission factors for various temperate sub-regions.
\DIFdelbegin %DIFDELCMD < 

%DIFDELCMD <   \tablecaption{Comparison of VOC emission ratios and emission factors reported in the literature for fires in temperate forests in Australia and in North America. Emission ratios (ER) are in mol mol$^{-1}$ and emission factors (EF) are in g kg$^{-1}$ dry fuel burnt.}
%DIFDELCMD <   \tablehead{
%DIFDELCMD <   \hline
%DIFDELCMD <    &\multicolumn{6}{c}{This study}&\multicolumn{3}{c}{References} \\
%DIFDELCMD <   &\multicolumn{4}{c}{White cell FTIR and SIT-MS analysis of grab samples}&\multicolumn{2}{c}{Open-path FTIR}&\multicolumn{2}{c}{Lawson et al.}&Akagi et al. \\
%DIFDELCMD <   &\multicolumn{4}{c}{- prescribed fires in NSW}&\multicolumn{2}{c}{- average values}&\multicolumn{2}{c}{2015}&2011 \\
%DIFDELCMD <   Species & MW & ref.  & ER & EF &ER &EF &ER &EF & EF   \\
%DIFDELCMD <   %& &species & & & & & & & \\%temperate  \\
%DIFDELCMD <  % &  & & & & & & & & forests \\
%DIFDELCMD <   \hline}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \tablecaption{Comparison of VOC emission ratios and emission factors reported in the literature for fires in temperate forests in Australia and in North America. Emission ratios (ER) are in mol mol$^{-1}$ and emission factors (EF) are in g kg$^{-1}$ dry fuel burnt. Unidentified species that are likely to contribute to the signal measured by SIFT-MS are listed by their molar mass in the last column.}
  \tablehead{
  \hline
  ...
  %&  & & & & & & & & forests \\
  \hline}
\DIFaddend % \tablelasttail{$^a$ includes benzaldehyde}
\begin{supertabular}{l l l r l r l l l c}
  ...
  & &  & & & & & & & 0.11 (0.05) \\
  & &  & & & & & & & (propanal)\\ \DIFaddbegin [\DIFadd{20mm}]
  \DIFaddend Acetic acid & 60  &CO & & & 0.020 & 4.5 (1.6) & & & 2.1 (0.7) \\
  &&&&&(0.009)&&&&\\ 
  \DIFdelbegin %DIFDELCMD < [%%%
\DIFdel{14mm}%DIFDELCMD < ]
%DIFDELCMD <   %%%
\DIFdelend Pyrrole & 67 & CO & 0.0006 & 0.16 $\pm$ 0.08 & & & && 0.012 (0.009) \\
  &&&$\pm$ 0.0003&&&&&&(pyrrole) \\
  & & & & & & & & & 0.047 (0.026) \DIFdelbegin %DIFDELCMD < \\
%DIFDELCMD <   & &  & & & & & & & %%%
\DIFdel{(? MW67}\DIFdelend \DIFaddbegin \DIFadd{(MM67}\DIFaddend )\\
 %DIF >  & &  & & & & & & & (MM67)\\
  sum of furan  & 68  & CO & 0.0019 & 0.5 $\pm$ 0.1 & & & 0.0053 & 1.7 & 0.3 (0.1)  \\ 
  and isoprene &&&$\pm$ 0.0003&&&&&& (furan)\\ 
  & &  & & &&&&&0.10(0.004) \\
  & &  & & &&&&&(isoprene)\\
  &&&&&&&&& 0.18 (0.08) \DIFdelbegin %DIFDELCMD < \\
%DIFDELCMD <   &&&&&&&&& %%%
\DIFdel{(? MW68}\DIFdelend \DIFaddbegin \DIFadd{(MM68}\DIFaddend ) \\
%DIF >   &&&&&&&&& (MM68)\\
  sum of MACR,   & 70 &CO & 0.0035 & 1.0 $\pm$ 0.3 & & & 0.0012 & 0.38 & 0.05 (0.02)  \\ 
  MVK and  & &  & $\pm$ 0.0009 & && & & & (\DIFdelbegin \DIFdel{MACR)}\DIFdelend \DIFaddbegin \DIFadd{methacrolein)) }\DIFaddend \\
  2-butenal&&&&&&&&&0.16 (0.04) \\
  &&&&&&&&& (\DIFdelbegin \DIFdel{MVK}\DIFdelend \DIFaddbegin \DIFadd{methyl vinyl ketone}\DIFaddend ) \\
  &&&&&&&&& 0.2 (0.1) \\
  &&&&&&&&& (2-butenal)\\
  &&&&&&&&& 0.3 (0.2) \DIFdelbegin %DIFDELCMD < \\
%DIFDELCMD <   &&&&&&&&& %%%
\DIFdel{(? MW70}\DIFdelend \DIFaddbegin \DIFadd{(MM70}\DIFaddend ) \\
%DIF >   &&&&&&&&& (? MM70) \\
  Butanone & 72 & CO & 0.00082 & 0.25 $\pm$ 0.05& & & 0.001 & 0.35 & 0.13 (0.04)  \\ 
  &&&$\pm$ 0.00007&&&&&& (butanone) \\
  &&&&&&&&&0.09 (0.04) \DIFdelbegin %DIFDELCMD < \\
%DIFDELCMD <   &&&&&&&&&%%%
\DIFdel{(? MW72}\DIFdelend \DIFaddbegin \DIFadd{(MM72}\DIFaddend ) \\
%DIF >   &&&&&&&&&(MM72)\\
